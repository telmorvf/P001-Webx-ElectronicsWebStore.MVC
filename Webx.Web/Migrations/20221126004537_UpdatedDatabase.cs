    ...
    public partial class UpdatedDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckoutTemps", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOnlineStore = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckoutTempDataId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_CheckoutTemps_CheckoutTempDataId",
                        column: x => x.CheckoutTempDataId,
                        principalTable: "CheckoutTemps",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkerIDId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AppointmentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BegginingHour = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_WorkerIDId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_WorkerIDId",
                table: "Appointments",
                column: "WorkerIDId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CheckoutTempDataId",
                table: "AspNetUsers",
                column: "CheckoutTempDataId");
